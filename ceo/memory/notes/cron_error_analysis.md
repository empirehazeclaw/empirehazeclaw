...
### 1. SECURITY: Buffer [TOKEN_REDACTED] — INVALID (seit 2026-04-07)
**Severity:** HIGH
...
**Severity:** HIGH
**Status:** Wartet auf manuelle Action ([NAME_REDACTED] muss Keys rotieren)
...
- Oder funktionieren bereits korrekt (KG Access Updater, [TOKEN_REDACTED] Budget Tracker)
...
| [TOKEN_REDACTED] Budget Tracker | ✅ OK | 20h ago | None |
...
### 🔴 Noch zu fixen:
1. **6 API Keys auf Rotation** — [NAME_REDACTED] muss manuell Keys erneuern
2. **Buffer [TOKEN_REDACTED]** — Script existiert nicht mehr in aktiver Form
...
**Was wirklich fehlt:** [NAME_REDACTED]'s manuelle Action für API Key Rotation.