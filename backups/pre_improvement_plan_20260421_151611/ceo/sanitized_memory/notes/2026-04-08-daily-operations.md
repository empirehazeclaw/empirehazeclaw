...
2. **University Self-Improvement** — Delivery target von @heartbeat → {{USER_ID_1}}
...
- Fix: Delivery target geändert zu {{USER_ID_1}} ([USER]'s Telegram ID)
