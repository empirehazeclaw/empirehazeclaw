...
| Tag | Task | Script |
|-----|------|--------|
| 1 | Failure Logger | `failure_logger.py` |
| 2 | Post-Mortem Template | `memory/evaluations/postmortems/` |
| 3 | Contrastive Analyzer | `contrastive_analyzer.py` |
| 4 | Causal Pattern Miner | `causal_pattern_miner.py` |
| 5 | Integration + Test | - |

### Woche 2:
| Tag | Task | Script |
|-----|------|--------|
| 1 | Exploration Budget | `exploration_budget.json` |
| 2 | Strategy Mutator | `strategy_mutator.py` |
| 3 | Exploration Controller | `exploration_controller.py` |
| 4 | Meta-Learning Core | `evaluation_framework.py` |
| 5 | Integration + Test | - |
